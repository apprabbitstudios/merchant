...
class AuthorizeAIMResponse(models.Model):
    ...
    address_verification_response = models.CharField(max_length=8,
        choices=ADDRESS_VERIFICATION_RESPONSE)
    ...
    card_code_response = models.CharField(max_length=8,
        choices=CARD_CODE_RESPONSES, help_text=u'Card Code Verification response')
